...
export class _ERC20__strategiesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class _ERC20 extends ethereum.SmartContract {
  static bind(address: Address): _ERC20 {
    return new _ERC20("_ERC20", address);
  }
  ...
  strategies(arg0: Address): _ERC20__strategiesResult {
    let result = super.call(
      "strategies",
    ...
    return new _ERC20__strategiesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_strategies(arg0: Address): ethereum.CallResult<_ERC20__strategiesResult> {
    let result = super.tryCall(
      "strategies",
      "strategies(address):(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(arg0)]
