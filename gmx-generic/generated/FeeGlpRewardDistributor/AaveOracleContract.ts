...
export class AaveOracleContract extends ethereum.SmartContract {
  static bind(address: Address): AaveOracleContract {
    return new AaveOracleContract("AaveOracleContract", address);
  }
